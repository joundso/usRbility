...
my_desc$set(
  Description = paste0(
    "Questions and evaluation functions for popular usability",
    " testing tools like the 'System Usability Scale' (SUS), or",
...
usethis::use_git_ignore("!/renovate.json")
usethis::use_git_ignore("!/references.bib")
usethis::use_git_ignore("!/.spelling")
usethis::use_git_ignore("!/README.Rmd")
usethis::use_git_ignore("!/ieee.csl")
...
usethis::use_git_ignore("!/data-raw")
usethis::use_git_ignore("/data-raw/*")
usethis::use_git_ignore("!/data-raw/debugging.R")
usethis::use_git_ignore("!/data-raw/devstuffs.R")
usethis::use_git_ignore("!/data-raw/questions.csv")
usethis::use_git_ignore("!/data-raw/questions.R")
usethis::use_git_ignore("!/data-raw/sus_results_demo.csv")
